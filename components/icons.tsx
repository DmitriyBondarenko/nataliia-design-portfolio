...
export function SystemIcon({ size = 26 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M10.4 6.9 6.6 15.9M13.6 6.9l3.8 9M7.4 18h9.2" />
    </svg>
  );
}

export function CursorIcon({ size = 19 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
      ...
      aria-hidden="true"
    >
      <path d="M5 3.2 19.4 11 12.6 12.6 11 19.4 5 3.2Z" />
    </svg>
  );
}

export function PlayIcon({ size = 19 }: { size?: number }) {
  return (
