    ...
    <section id="contact" data-screen-label="Contact" className="px-3.5 pt-3.5 pb-[clamp(20px,3vw,34px)]">
      <div className="relative overflow-hidden rounded-panel-lg bg-ink-deep px-[clamp(22px,5vw,72px)] py-[clamp(36px,7vw,96px)]">
        ...
        <div className="relative">
          ...
          <p className="m-0 mt-[clamp(20px,3vw,34px)] max-w-[68ch] text-[20px] max-sm:text-[18px] leading-[1.55] text-bg-base/72">
          ...
          <div className="mt-[clamp(26px,4vw,44px)] flex flex-wrap gap-3">
            <a
              ...
              className="flex items-center gap-3.5 rounded-pill bg-bg-base py-2 pr-2 pl-6.5 text-[20px] max-sm:text-[18px] font-medium text-ink transition-colors hover:bg-bronze hover:text-bg-base"
            >
              Написати в Telegram
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3.5 rounded-pill border border-bg-base/28 bg-bg-base/10 py-2 pr-2 pl-6.5 text-[20px] max-sm:text-[18px] font-medium text-bg-base transition-colors hover:bg-bg-base/20"
            >
          ...
          <div className="mt-[clamp(34px,5vw,64px)] flex flex-wrap max-sm:flex-nowrap items-baseline justify-between gap-4 max-sm:gap-2 border-t border-bg-base/14 pt-5.5">
            <p className="m-0 text-[18px] max-sm:text-[clamp(9px,2.4vw,15px)] whitespace-nowrap text-bg-base/50">
              Nataliia Bondarenko — Creative &amp; Motion Designer
            </p>
            <p className="m-0 text-[18px] max-sm:text-[clamp(9px,2.4vw,15px)] tracking-[0.1em] whitespace-nowrap text-bg-base/50">
              {"/// 2026"}
            </p>
          </div>
        </div>
